...
import { 
  ...
  CalendarDays, MessageSquare, PieChart, Palette, 
  Bell, BookOpen, Megaphone
} from 'lucide-react';
...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 flex-shrink-0 h-full bg-[#1A2942] text-white shadow-lg overflow-y-auto">
