    ...
    <footer className="bg-slate-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-xl mb-4">Menu360</h3>
            <p className="text-slate-300 mb-4">
              The complete mobile-first platform for restaurant management.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="#testimonials" className="text-slate-300 hover:text-white transition-colors">Testimonials</Link></li>
              <li><Link to="/request-demo" className="text-slate-300 hover:text-white transition-colors">Request Demo</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/support" className="text-slate-300 hover:text-white transition-colors">Support Center</Link></li>
              <li><Link to="/documentation" className="text-slate-300 hover:text-white transition-colors">Documentation</Link></li>
              <li><Link to="/partners" className="text-slate-300 hover:text-white transition-colors">Partners</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 text-center sm:text-left sm:flex sm:items-center sm:justify-between">
          ...
          <div className="mt-4 sm:mt-0">
            <div className="flex justify-center sm:justify-end space-x-6">
              ...
              <Link to="/cookies" className="text-slate-400 hover:text-white transition-colors text-sm">Cookie Policy</Link>
            </div>
          </div>
        </div>
      </div>
